...
public class AmqpClient {  //获取实时数据，需要启动app
    private final static Logger logger = LoggerFactory.getLogger(AmqpClient.class);
    private static String accessKey = "LTAI5t8nVKMfKzzZUJJZezuZ";
    private static String accessSecret = "9EtmUDav7fzlo2fqFo7IBFxIaKetO4";
    private static String consumerGroupId = "DEFAULT_GROUP";

    //iotInstanceId：实例ID。若是2021年07月30日之前（不含当日）开通的公共实例，请填空字符串。
    private static String iotInstanceId = "iot-06z00e70fl6u9ju";

    //控制台服务端订阅中消费组状态页客户端ID一栏将显示clientId参数。
    //建议使用机器UUID、MAC地址、IP等唯一标识等作为clientId。便于您区分识别不同的客户端。
    private static String clientId = "12345678";

    //${YourHost}为接入域名，请参见AMQP客户端接入说明文档。
    private static String host = "iot-06z00e70fl6u9ju.amqp.iothub.aliyuncs.com";

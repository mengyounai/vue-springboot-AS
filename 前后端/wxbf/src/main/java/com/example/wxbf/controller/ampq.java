...
public class ampq {
    ...
    private static String accessKey = "LTAI5tGD9EP9YMEgrGLRWkH6";
    private static String accessSecret = "R0SClrvQTlmzm299TRgVSyj6LkaQ0w";
    private static String consumerGroupId ="DEFAULT_GROUP";

    //iotInstanceId：实例ID。若是2021年07月30日之前（不含当日）开通的公共实例，请填空字符串。
    private static String iotInstanceId = "iot-06z00et4xyo88k6";
    ...
    private static String host = "iot-06z00et4xyo88k6.amqp.iothub.aliyuncs.com";
    ...
    public static JSON  processMessage(Message message) throws JSONException {
        ...
        try {
            ...
            System.err.println("1111111111111111"+ jsonObject);
            json = jsonObject;
